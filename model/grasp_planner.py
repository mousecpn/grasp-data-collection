...
class VGNImplicit(object):
    def __init__(self, model_path, best=False, force_detection=False, qual_th=0.9, out_th=0.1, visualize=False, resolution=40, **kwargs):
    ...
    def predict(self, tsdf_vol, pos, net, device):
        ...
        qual_vol = qual_vol.sigmoid().detach()
